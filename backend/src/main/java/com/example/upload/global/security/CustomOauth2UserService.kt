...
class CustomOauth2UserService(
    ...
    override fun loadUser( userRequest: OAuth2UserRequest): OAuth2User {
        ...
        val oauthId: String = oAuth2User.name //식별자
        ...
        val propeties = attributes.get("properties") as Map<String, Object>

        val nickname: String = propeties.get("nickname") as String
        val profileImage = propeties.get("profile_image") as String
